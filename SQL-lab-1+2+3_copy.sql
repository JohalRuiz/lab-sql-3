...
-- Question 6. What are the shortest and longest movie duration? 
...
select * from sakila.customer;
select concat(first_name, ' ', last_name, ' - ', lcase(email)) as 'Formatted'
...
select datediff(max(last_update), min(rental_date)) as 'Operating period'
from sakila.rental;
-- 
